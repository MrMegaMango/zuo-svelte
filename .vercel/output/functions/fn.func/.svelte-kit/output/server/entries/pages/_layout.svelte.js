import "clsx";
import { c as pop, p as push, d as stringify } from "../../chunks/index2.js";
...
function Header($$payload, $$props) {
  push();
  $$payload.out += `<header class="svelte-1u9z1tp"><div class="corner svelte-1u9z1tp"><a href="https://svelte.dev/docs/kit" class="svelte-1u9z1tp"><img${attr("src", logo)} alt="SvelteKit" class="svelte-1u9z1tp"></a></div> <nav class="svelte-1u9z1tp"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-1u9z1tp"></path></svg> <ul class="svelte-1u9z1tp"><li${attr("aria-current", page.url.pathname === "/" ? "page" : void 0)} class="svelte-1u9z1tp"><a${attr("href", `${stringify(base)}/`)} class="svelte-1u9z1tp">Home</a></li> <li${attr("aria-current", page.url.pathname === "/about" ? "page" : void 0)} class="svelte-1u9z1tp"><a${attr("href", `${stringify(base)}/about`)} class="svelte-1u9z1tp">About</a></li> <li${attr("aria-current", page.url.pathname.startsWith("/sverdle") ? "page" : void 0)} class="svelte-1u9z1tp"><a${attr("href", `${stringify(base)}/sverdle`)} class="svelte-1u9z1tp">Sverdle</a></li></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-1u9z1tp"></path></svg></nav> <div class="corner svelte-1u9z1tp"></div></header>`;
  pop();
}
function _layout($$payload, $$props) {
  push();
  let { children } = $$props;
  $$payload.out += `<div class="app svelte-1fv15k5">`;
  Header($$payload);
  $$payload.out += `<!----> <button class="back-button svelte-1fv15k5">← Back to Zuo's landing page</button> <main class="svelte-1fv15k5">`;
  children($$payload);
  $$payload.out += `<!----></main> <footer class="svelte-1fv15k5"><p>built with DeepSeek because AI knows better than reading docs</p></footer></div>`;
  pop();
}
export {
  _layout as default
